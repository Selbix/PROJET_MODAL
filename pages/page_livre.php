...
//echo generateHTMLHeader($books[0]["titre"], "styles/styles.css");
////var_dump($books);
...
<div class="book-container2">
        ...
        <div class="book-details2">
            ...
            <div class="action-buttons2">
                <a href="utilitaires/download.php?id=<?php echo $books[0]['id']; ?>" class="btn2 btn-download2">Télécharger</a>
                <a target = "_blank" href="BDD-gestion/books/<?php echo $books[0]['id']; ?>.pdf" class="btn2 btn-read2">Lire</a>
...
function submitReview(bookId, userId, rating) {
    ...
    fetch("utilitaires/submit_review.php", {
        method: "POST",
        body: formData
    })
    .then(response => response.json())
